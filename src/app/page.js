...
export default function Home() {
  return (
    <main>
      ...
      {/* Hero Section */}
      <section className="bg-[#023373] text-white py-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <a
            href="/services"
            className="inline-block bg-yellow-400 text-[#023373] px-6 py-3 rounded-md text-sm font-semibold hover:bg-yellow-300 transition"
          >
            Explore Services
          </a>
        </div>
      ...
      <section className="py-16 bg-white text-center px-4">
        <h2 className="text-3xl font-bold text-[#023373] mb-10">
          Discover Our Key Features
        </h2>

        <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
          <div className="shadow-md p-6 rounded-lg border">
            <h3 className="text-xl font-semibold mb-2 text-[#023373]">
      ...
      <section className="bg-gray-50 py-16 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            <h3 className="text-4xl font-bold text-[#023373] mb-2">300K+</h3>
            <p className="text-gray-600 text-sm">Customers</p>
          </div>
          <div>
            <h3 className="text-4xl font-bold text-[#023373] mb-2">90%</h3>
            <p className="text-gray-600 text-sm">Retention Rate</p>
          </div>
          <div>
            <h3 className="text-4xl font-bold text-[#023373] mb-2">80+</h3>
            <p className="text-gray-600 text-sm">Partners</p>
          </div>
          <div>
            <h3 className="text-4xl font-bold text-[#023373] mb-2">70%</h3>
      ...
      <section className="py-16 bg-white px-6">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-[#023373] mb-6">About Us</h2>
          ...
          <h3 className="text-xl font-semibold text-[#023373] mb-4">
            Why we are the best in the marketplace
          </h3>

          <div className="grid gap-6 md:grid-cols-3 text-left text-gray-700 mt-4">
            <div>
              <h4 className="font-bold text-[#023373] mb-2">Anywhere, Anytime</h4>
              <p>Banking that fits your lifestyle, wherever you are.</p>
            </div>
            <div>
              <h4 className="font-bold text-[#023373] mb-2">Peace of Innovation</h4>
              <p>We’re constantly evolving to serve you better.</p>
            </div>
            <div>
              <h4 className="font-bold text-[#023373] mb-2">Secured and Smooth</h4>
      ...
      <section className="bg-gray-100 py-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-[#023373] mb-6">Contact Us</h2>
